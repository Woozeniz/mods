...
message.channel.send(`<a:knave_onay:${client.config.onayemoji}> **${kullanici.user.tag}** adlı kullanıcı __${sebep}__ Sebebiyle **${message.author.tag}** Tarafından yasaklandı.`) 
banlog.send(`<a:knave_onay:${client.config.onayemoji}> **${kullanici.user.tag}** adlı kullanıcı __${sebep}__ Sebebiyle **${message.author.tag}** Tarafından yasaklandı.`);
}
